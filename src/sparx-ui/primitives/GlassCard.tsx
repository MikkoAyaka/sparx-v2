...
export const GlassCard = React.forwardRef<HTMLDivElement, GlassCardProps>(
  (
    ...
    const variantStyles = {
      stage: isEmerald
        ? "bg-white border border-slate-200 shadow-[0_1px_2px_rgba(0,0,0,0.03)] text-slate-900"
        : "bg-[#030406] border border-white/10 shadow-2xl text-white",
      elevated: isEmerald
        ? "bg-slate-50 border border-slate-200 shadow-[0_1px_2px_rgba(0,0,0,0.03)] text-slate-900"
        : "bg-[#08090E] border border-white/10 shadow-xl text-white",
      translucent: isEmerald
        ? "bg-white/80 border border-slate-200 backdrop-blur-md shadow-[0_1px_2px_rgba(0,0,0,0.03)] text-slate-900"
